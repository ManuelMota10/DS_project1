...
This project, developed for the Elements of Artificial Intelligence and Data Science course (1st Year, 2nd Semester, 2024/2025), Assignment No. 2, aims to predict student pass/fail outcomes using the UCI Student Performance dataset. The goal is to identify at-risk students (32.91% fail) for targeted interventions, supporting educational decision-making.
